...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#selectFartherId").val(ajaxData.data["fartherId"]);
		if ($("#selectLevel").val() != "1") {
...
<body>
	<div class="container">
		<form id="editForm">
			<input id="textId" name="textId" type="text" size="35" class="hidden" />
			<table class="mainTable">
				<tr>
					<td class="mainTable_TitleTd" colspan="4">修改科室信息</td>
				</tr>
				<tr>
