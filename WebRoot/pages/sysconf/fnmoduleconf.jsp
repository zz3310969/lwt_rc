...
<head>
	...
	<script type="text/javascript" src="<%=path %>/content/js/pagination.js<s:property value='JsVersion'/>"></script>
	<script type="text/javascript" src="<%=path %>/content/js/sysconf/fnmoudleconf.js?a"></script>
</head>
<body>
	<div class="main">
		<div class="queryarea">
			<div class="barea">
				<input type="button" class="btn" id="btn_new_module" value="新模块" style="margin-right:15px;"/>
				<ul class="querylist">
			...
			<table class="tables" id="tbl_pagelist">
				<thead>
					<tr>
						...
						<th style="width:120px;">模块等级</th>
						<th style="width:80px;">排序</th>
						<th style="width:80px;">是否公共</th>
