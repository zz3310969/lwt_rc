...
var tb_pathToImage = "/lwt_rc/Images/isRunning.gif";
				...
				$("#TB_window")
						.append(
								"<a href='' id='TB_ImageOff' title='Close'><img id='TB_Image' src='"
										...
										+ TB_PrevHTML
										+ TB_NextHTML
										+ "</div></div><div id='TB_closeWindow'><a href='#' id='TB_closeWindowButton' title='Close' style='text-decoration:none;'>【关闭】</a> </div>");
					...
					$("#TB_window")
							.append(
									"<div id='TB_title'><div id='TB_ajaxWindowTitle'>"
											+ caption
											+ "</div><div id='TB_closeAjaxWindow'><a href='#' id='TB_closeWindowButton' title='Close' style='text-decoration:none;'>【关闭】</a> </div></div><iframe frameborder='0' hspace='0' src='"
											+ urlNoQuery[0]
					...
					if (params['modal'] != "true") {// ajax no modal
						$("#TB_window")
								.append(
										"<div id='TB_title'><div id='TB_ajaxWindowTitle'>"
												+ caption
												+ "</div><div id='TB_closeAjaxWindow'><a href='#' id='TB_closeWindowButton' style='text-decoration:none;'>【关闭】</a> </div></div><div id='TB_ajaxContent' style='width:"
