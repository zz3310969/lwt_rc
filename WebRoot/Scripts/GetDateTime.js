...
function CalConv() {
    ...
    var year = browser.msie ? today.getYear() : today.getYear() + 1900;
    document.write(year, "年", today.getMonth() + 1, "月", today.getDate(), "日 ", d[today.getDay() + 1], "  ", "农历", LunarMonth, "月", LunarDate, "日");
    return 0;
}
